...
- **Timing stats**: `telemetry.StatsCollector` incrementally folds turns/steps and model, TTFT, and tool wall times (turn-deduped).
...
- `pkg/telemetry/stats.go` — incremental session timing stats
